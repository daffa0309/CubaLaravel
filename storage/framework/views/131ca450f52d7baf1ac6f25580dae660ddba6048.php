...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3 row">
                                        <label class="col-sm-3 col-form-label" for="bobotKriteria">Bobot Kriteria</label>
                                        <div class="col-sm-12">
...
unset($__errorArgs, $__bag); ?>"
                                                required id="bobotKriteria" name="bobotKriteria" type="text"
                                                placeholder="Input Kriteria">
                                ...
                                <div class="card-header">
                                    ...
                                    <?php if($lengthData = 0): ?>
                                        <div style="margin-left: 1080px">
                                            <a class="btn btn-primary" href="<?php echo e(route('input-data')); ?>"
                                                type="button">Tambah
                                                Data</a>
                                        </div>
                                    <?php endif; ?>
...
<?php echo $__env->make('layouts.simple.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\df\Documents\CubaLaravel\resources\views/forms/default-form.blade.php ENDPATH**/ ?>