                ...
                <li class="profile-nav onhover-dropdown p-0 me-0 ">
                    <div class="media profile-media">
                        ...
                        <div class="media-body">
                            ...
                            <p class="mb-0 font-roboto"><?php echo e(auth()->user()->level); ?> <i
                                    class="middle fa fa-angle-down"></i></p>
                        </div>
                    </div>
                    <ul class="profile-dropdown onhover-show-div">
                        <li><a href="<?php echo e(route('data-user')); ?>"><i data-feather="user"></i><span>Account </span></a></li>
                        <li><a href="<?php echo e(route('edit-profile')); ?>"><i data-feather="user"></i><span>Edit
                                    Profile</span></a></li>
...
<?php /**PATH C:\Users\df\Documents\CubaLaravel\resources\views/layouts/simple/header.blade.php ENDPATH**/ ?>