			...
			<div id="sidebar-menu">
				<ul class="sidebar-links" id="simple-bar">
					...
					<li class="sidebar-list">
							...
							<li><a class="lan-4 <?php echo e(Route::currentRouteName()=='index' ? 'active' : ''); ?>" href="<?php echo e(route('index')); ?>"><?php echo e(trans('lang.Dashboard')); ?></a></li>
					</li>
...
</div><?php /**PATH C:\Users\daffa\CubaLaravel\resources\views/layouts/simple/sidebar.blade.php ENDPATH**/ ?>