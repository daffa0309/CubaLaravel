                ...
                <li class="profile-nav onhover-dropdown p-0 me-0 ">
                    <div class="media profile-media">
                        ...
                        <div class="media-body">
                            ...
                            <p class="mb-0 font-roboto">{{ auth()->user()->level }} <i
                                    class="middle fa fa-angle-down"></i></p>
                        </div>
                    </div>
                    <ul class="profile-dropdown onhover-show-div">
                        <li><a href="{{ route('data-user') }}"><i data-feather="user"></i><span>Account </span></a></li>
                        <li><a href="{{ route('edit-profile') }}"><i data-feather="user"></i><span>Edit
                                    Profile</span></a></li>
